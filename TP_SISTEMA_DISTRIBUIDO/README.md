...
./bin/nombre_de_ejecutable

## Ejecucion del programa, pero revisando si hay fuga de memoria con valgrind en tiempo de ejecucion
valgrind --leak-check=yes ./bin/nombre_de_ejecutable
